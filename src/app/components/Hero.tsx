...
export default function Hero() {
  return (
    <section className="relative bg-nf-black overflow-hidden pt-10 md:pt-16 pb-16 md:pb-24 lg:pb-32">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Imagen con efectos — PRIMERO en móvil, SEGUNDO en desktop */}
          <div className="relative group order-1 md:order-2">
            ...
            <div
              className="absolute -bottom-4 -left-4 w-32 h-32 bg-nf-yellow/10 rounded-full blur-2xl animate-pulse"
            ...
            <div className="space-y-6">
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black leading-[1.1] text-nf-white">
                ...
                <span className="relative inline-block">
                  ...
                  <span className="absolute bottom-2 left-0 w-full h-3 bg-nf-yellow/20 -rotate-1" style={{ zIndex: 0 }} />
                </span>
                ,<br />
                te enseño a{" "}
                <span className="relative inline-block">
              ...
              <p className="text-lg sm:text-xl text-nf-white/80 leading-relaxed max-w-xl">
                ...
                Fuerza, técnica y salud para resultados{" "}
                <strong className="text-nf-yellow font-semibold">sostenibles</strong>.
              </p>
            </div>
